...
such as you may already have in a spreadsheet or a CSV file. Let us start by
...
`"black"` is nonsense, you are right - and you already have some intuition for an
...
Oh no, our weights are not the double type anymore! If we try to do the same math
...
Let us explore more about different data structures and how they behave. 
For now, we will remove that extra line from our cats data and reload it, 
...
To better understand this behavior, here is another of the data structures:
the *vector*.
...
you do not choose the datatype, it will default to `logical`; or, you can declare
...
case `[1:3]`; and a few examples of what is actually in the vector - in this case
...
data.frames are all vectors*, and that is the root of why R forces everything in
...
> > number, then you can interpret *all* of them as numbers, so we do not have to
...
Given what we have learned so far, what do you think the following will produce?
...
data does not look like what you thought it was going to look like, type coercion
...
example, we can make a vector of strings labelling cat colorations for all the
cats in our study:
...
In modelling functions, it is important to know what the baseline levels are. This
...
In this case, we have explicitly told R that "control" should be represented by 1, and
"case" by 2. This designation can be very important for interpreting the
results of statistical models!

## Lists

Another data structure you all want in your bag of tricks is the `list`. A list
...
> > ```
> > Note: it is nice to make a list in big writing on the board or taped to the wall
