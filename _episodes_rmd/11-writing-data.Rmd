...
you are looping through multiple subsets of a file, plotting data from
each subset, and you want to save each plot, but obviously can not stop
...
At some point, you will also want to write out data from R.
...
Hmm, that is not quite what we wanted. Where did all these
...
```{r, echo=FALSE}
# We remove after rendering the lesson, because we do not want this in the lesson
# repository
