...
If a package does not have any vignettes, you can usually find help by typing
`help("package-name")`.
...
If you are not sure what package a function is in, or how it is specifically spelled you can do a fuzzy search:
...
If you do not know what function or package you need to use
[CRAN Task Views](http://cran.at.r-project.org/web/views)
is a specially maintained list of packages grouped into
fields. This can be a good starting point.

## When your code does not work: seeking help from your peers

If you are having trouble using a function, 9 times out of 10,
...
If you can not find the answer, there are a few useful functions to
...
Will dump the data you are working with into a format so that it can
...
> ## Challenge 2
>
> Look at the help for the `paste` function. You will need to use this later.
