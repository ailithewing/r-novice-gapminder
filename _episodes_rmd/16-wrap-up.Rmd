...
since you are still learning yourself and it can help to clarify concepts and
remind you later. However, these comments are not particularly useful later on
when you do not remember what problem your code is trying to solve. Try to also
include comments that tell you *why* you are solving a problem, and *what* problem
that is. The *how* can come after that: it is an implementation detail you ideally
