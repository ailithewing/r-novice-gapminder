...
Science is a multi-step process: once you have designed an experiment and collected
...
Throughout this lesson, we are going to teach you some of the fundamentals of
the R language as well as some best practices for organizing code for
scientific projects that will make your life easier.

We will be using RStudio: a free, open source R Integrated Development
...
And R will print out the answer, with a preceding "[1]". Do not worry about this
for now, we will explain that later. For now think of it as indicating output.
...
means it is waiting for you to complete the command. If you want to cancel
a command you can hit <kbd>Esc</kbd> and RStudio will give you back the ">" prompt.

> ## Tip: Canceling commands
>
> If you are using R from the command line instead of from within RStudio,
> you need to use <kbd>Ctrl</kbd>+<kbd>C</kbd> instead of <kbd>Esc</kbd>
> to cancel the command. This applies to Mac users as well!
>
> Canceling a command is not only useful for killing incomplete commands:
> you can also use it to tell R to stop running code (for example if it is
> taking much longer than you expect), or to get rid of the code you are
> currently writing.
>
{: .callout}
...
Do not worry about trying to remember every function in R. You
...
We will go through an example later.
...
Note here that we did not give any arguments to `ls`, but we still
...
The object `ls` contains the R code that makes the `ls` function work! We will talk
...
In this case we have combined the two. Like the order of operations, anything
inside the innermost parentheses is evaluated first, and so on.

In this case we have specified that the results of `ls` should be used for the
